...
def construct_mresp_model(inputDf, target, nrounds, lr, startingModels, penalties={}, grad=calculus.Poisson_grad):
  ...
  for m in range(len(models)):
   ...
   for col in model["conts"]:
    ...
    for i in range(len(totalAffectList)):
     ...
     models[m] = pena.penalize_this_cont_col(models[m], col, penalties)
